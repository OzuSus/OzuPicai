        ...
        >
            ...
            >
                ...
                <div className="absolute inset-0">
                    <img src={beforeImage} alt="Before - Original car on road"
                ...
                >
                    <img src={afterImage} alt="After - Car with snowy alpine background"
                         className="w-full h-full object-cover select-none"/>
                </div>
                ...
                >
                    <div
                        className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-8 h-8 bg-gradient-primary rounded-full shadow-glow-primary group-hover:scale-110 transition-transform flex items-center justify-center">
                ...
                {/*    Labels Before/After*/}
                <div className="absolute bottom-4 left-4 text-xs font-medium text-muted-foreground">AFTER</div>
                <div className="absolute bottom-4 right-4 text-xs font-medium text-primary">BEFORE</div>
            </div>
            <motion.p
