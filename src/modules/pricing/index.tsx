...
const Pricing = () => {
    ...
    return (
        <section id="pricing" className="py-24 relative overflow-hidden">
            {/*    backgrounf effect*/}
            <div className="absolute top-0 left-1/4 w-96 h-96 bg-primary/10 rounded blur-3xl"/>
            <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-secondary/10 rounded blur-3xl"/>
