            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                >
                    ...
                    <h2 className="text-4xl lg:text-6xl font-bold mb-6">
                        ...
                        <span className="bg-gradient-primary !bg-clip-text text-transparent">Magic Plan</span>
                    </h2>
                        ...
                        >
                            {plan.popular && (
                                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 z-10">
                                    <div className="bg-gradient-primary px-6 py-2 rounded-full text-sm font-bold text-background">Most Popular</div>
                                </div>
                            )}

                            <div className={`h-full glass rounded-2xl p-8 border transition-all duration-300 ${
                                    plan.popular
                            ...
                            >
                                ...
                                <Button variant={plan.popular ? "hero" : "secondary"}
                ...
                >
                    <p className="text-muted-foreground">All plans include access to our core AI features. Upgrade anytime for more power.
                    </p>
                </motion.div>
            </div>
        </section>
